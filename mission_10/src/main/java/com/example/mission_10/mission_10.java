...
public class mission_10 extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mainFragment = new mission_10_MainFragment();
